...
This tutorial is intended to provide a guide for creating social network
datasets based on data pulled from Twitter and useful tools for
analysis.
...
<img src="flow_diagram.png" width="552" />
...
the source R Markdown script *index.Rmd* generates this Markdown file.
