...
or fork and clone the [twitter-sna repository](https://github.com/nrjess/twitter-sna) 
to your computer using the usual Git commands (Bryan, 2018; Bryan et al., n.d., Chapter 16). 
We suggest the method shown in 
...
This diagram shows the sequence that scripts should be run to ensure that the required 
inputs have been created. Click the boxes below to see the step-by-step tutorial 
for each script.

```{r data-flow-diagram, echo=FALSE, message=FALSE}
library(DiagrammeR)
