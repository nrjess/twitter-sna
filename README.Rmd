...
[Section 16.2](https://happygitwithr.com/existing-github-first.html#git-clone-usethis-rstudio).
...
* `twitter-sna`: This is the root folder for the repository.
    ...
    * `scripts`: This folder is where you can find the key files you will need to
      use if you want to re-run our analyses on your own computer.
    ...
    * `README.md`: This file is obtained by knitting the `README.Rmd` file and 
      ...
      manually: just re-knit `README.Rmd` to update it. In R Studio, you can 
