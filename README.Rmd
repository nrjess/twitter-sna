    ...
    * `scripts`: This folder is where you can find the key files you will need to
      use if you want to run these analyses on your own computer.
        ...
        * `create_social_network_data.RMD` This script restructures tweet data 
        ...
        nodelists).
        * `sentiment_analysis.RMD` This script codes tweets for sentiment. This example codes          for positive and negative sentiments 
...
fwd [label = 'scripts/\npath_visualizations.Rmd', fillcolor = lightblue]
