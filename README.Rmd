...
### List of Tools
This section lists and briefly describes each script found in the scripts folder 
in the *twitter-sna* repository. 

- *scrape_tweets.RMD*: Create a user-defined query, scrape tweet data, and save 
  to a local repository.
- *create_social_network_data.RMD*: Restructure tweet data into a format that is 
  useful for social network analysis (edgelist and nodelist).
- *dynamic_visualizations.RMD*: Create a dynamic visualization that shows the 
  changes in the network over time.
- *sentiment analysis.RMD*: Code tweets for sentiment for use in influence 
  models. This example codes for positive and negative sentiments but tweets 
...
node [shape = box, style = filled, fillcolor = lightblue, fixedsize = FALSE]
scrape [label = 'scripts/\nscrape_twitter.Rmd']
data [label = 'scripts/\ncreate_social_network_data.Rmd']
viz [label = 'scripts/\nvisualizations.Rmd\n(coming soon!)']
dviz [label = 'scripts/\ndynamic_visualizations.Rmd']
fwd [label = 'scripts/\nforward_paths.Rmd\n(coming soon!)']
sent [label = 'scripts/\nsentiment_analysis.Rmd']
infl [label = 'scripts/\ninfluence_model.Rmd\n(coming soon!)']
select [label = 'scripts/\nselection_model.Rmd\n(coming soon!)']
