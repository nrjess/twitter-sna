...
pull [label = 'scripts/\npull_twitter.Rmd', fillcolor = lightblue]
data [label = 'scripts/\ncreate_social_network_data.Rmd', fillcolor = lightblue]
dviz [label = 'scripts/\ndynamic_visualizations.Rmd', fillcolor = lightblue]
fwd [label = 'scripts/\nforward_paths.Rmd', fillcolor = lightblue]
sent [label = 'scripts/\nsentiment_analysis.Rmd', fillcolor = lightblue]
key [label = 'scripts/\nkeyword_coding.Rmd', fillcolor = lightblue]
infl [label = 'scripts/\ninfluence_model.Rmd', fillcolor = lightblue]
sel [label = 'scripts/\nselection_model.Rmd', fillcolor = lightblue]
...
Running the code below opens the .Renviron file, add a line in the file, following the format: TWITTER_BEARER=YOURBEARERTOKENHERE, replacing YOURBEARERTOKENHERE with your actual bearer token retrieved from
