...
data scraped from twitter and demonstrate some useful tools for analysis.
...
* `twitter-sna`: This is the root folder for the repository.
    ...
    * `inst`: This folder is where you can find the key files you will need to
      ...
      package). 
        * `Example_Script.Rmd`: This .Rmd file serves as a basic template for
          new .Rmd scripts that we want to render PDF output. It sets up some 
          standard formatting and LaTeX packages we will likely need. 
