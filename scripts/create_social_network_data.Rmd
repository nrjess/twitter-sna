...
# Load data
This loads the data pulled from Twitter in the [pull_tweets.RMD](https://github.com/nrjess/twitter-sna/blob/main/scripts/pull_tweets.Rmd) 
script.
...
# Edgelist
Interaction information is extraqcted from the Tweet data and restructured into 
an edgelist.
...
This code creates and plots an *igraph* object to test that the integer edgelist 
works properly. Figure \@ref(fig:igraph) probably doesn't look very nice but for 
this script we just want to confirm that we are able to make a graph. Other scripts 
in this repository have code for making better graphs.
