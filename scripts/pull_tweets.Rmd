...
This process is structured to be useful with a a Twitter developer account with 
...
will get an error here if this is your first pull because there is no previous data 
...
captured by the defined query. Examining the text of the tweets will help you 
...
# Merge new data with previous pulls
