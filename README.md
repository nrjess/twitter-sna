...
<body>
    ...
    <map name="image-map">
        <area target="_blank" alt="Scrape Tweets" title="Scrape Tweets" href="URL_for_scrape_tweets" coords="x1,y1,x2,y2" shape="rect">
        <area target="_blank" alt="Create Social Network Data" title="Create Social Network Data" href="URL_for_create_social_network_data" coords="x3,y3,x4,y4" shape="rect">
        <area target="_blank" alt="Sentiment Analysis" title="Sentiment Analysis" href="URL_for_sentiment_analysis" coords="x5,y5,x6,y6" shape="rect">
        <area target="_blank" alt="The Influence Model" title="The Influence Model" href="URL_for_the_influence_model" coords="x7,y7,x8,y8" shape="rect">
        <!-- ... other areas ... -->
    </map>
</body>
</html>
